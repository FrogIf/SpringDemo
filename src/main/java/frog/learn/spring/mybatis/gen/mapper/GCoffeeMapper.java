package frog.learn.spring.mybatis.gen.mapper;
...
public interface GCoffeeMapper {
    ...
    @Insert({
        ...
        "values (#{name,jdbcType=VARCHAR}, #{price,jdbcType=BIGINT,typeHandler=frog.learn.spring.mybatis.common.typehandler.MoneyTypeHandler}, ",
    ...
    @Update({
        ...
        "set NAME = #{name,jdbcType=VARCHAR},",
          "PRICE = #{price,jdbcType=BIGINT,typeHandler=frog.learn.spring.mybatis.common.typehandler.MoneyTypeHandler},",
