...
import sch.frog.learn.spring.common.web.converter.MoneyReadConverter;
import sch.frog.learn.spring.common.web.converter.MoneyWriteConverter;
...
@AutoConfigureBefore({RedisReactorDemo.class, R2DBCCoffeeService.class})
public class ReactiveConfigure extends AbstractR2dbcConfiguration {
     ...
     */
    @Bean
    public ReactiveRedisTemplate<String, RCoffee> reactiveRedisTemplate(ReactiveRedisConnectionFactory connectionFactory){
        StringRedisSerializer keySerializer = new StringRedisSerializer();
        Jackson2JsonRedisSerializer<RCoffee> valueSerializer = new Jackson2JsonRedisSerializer<>(RCoffee.class);
        RedisSerializationContext.RedisSerializationContextBuilder<String, RCoffee> builder
                = RedisSerializationContext.newSerializationContext(keySerializer);
        RedisSerializationContext<String, RCoffee> context = builder.value(valueSerializer).build();
